...
class DefaultPage extends StatelessWidget {
  ...
  Future _JumpOne() async {
    SystemNavigator.pop();
    // final String result = await platform.invokeMethod('jumpTo');
    // print(result);
  }
}
...
class MyApp extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    print("end first ${new DateTime.now().millisecondsSinceEpoch}");
    return MaterialApp(
      title: 'Flutter Demo',
      theme: ThemeData(
        primarySwatch: Colors.blue,
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  @override
  Widget build(BuildContext context) {
    print("end ${new DateTime.now().millisecondsSinceEpoch}");
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            RaisedButton(
              child: Text('jump to AnotherActivity'),
